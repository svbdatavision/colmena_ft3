-- =====================================================
-- SCRIPT DIARIO PARA INSERTAR NUEVAS LICENCIAS EN MODELO_LM_202507_BASE
-- =====================================================
-- Este script procesa las licencias médicas diarias desde ALFIL 
...
cpa_historico_prestador AS (
    ...
    WHERE TO_DATE(FECHA_RECEPCION) < date_add(current_date(), -1)  -- Solo registros anteriores a ayer
...
-- Filtrar solo licencias de ayer (ALFIL se actualiza con las licencias del día anterior)
AND TO_DATE(ALFIL.FECHA_RECEPCION) = date_add(current_date(), -1);
...
-- 
-- IMPORTANTE: 
-- 1. Solo procesa licencias insertadas AYER
...
-- [Databricks] SET de variables de sesión removido; expresiones de fecha se mantienen inline.

-- ========================================================================================
-- TABLA 5: AFILIADO_METRICAS_15DIAS
-- Esta tabla SÍ se recalcula diariamente para las licencias de ayer
-- ========================================================================================
MERGE INTO OPX.P_DDV_OPX_MDPREDICTIVO.AFILIADO_METRICAS_15DIAS AS target
USING (
    WITH licencias_ayer AS (
        -- Licencias insertadas ayer
        ...
        WHERE DATE_TRUNC('DAY', FECHA_RECEPCION) = date_add(current_date(), -1)
    ),
...
-- =====================================================
-- INSERCIÓN DIARIA EN TABLA OPTIMIZADA
-- =====================================================
-- Este script inserta en MODELO_LM_202507_OPTIMIZADO las licencias
-- procesadas ayer, uniendo con las tablas de métricas actualizadas
-- IMPORTANTE: Replica exactamente las 284 columnas de la tabla OPTIMIZADO
-- =====================================================

-- Insertar solo las licencias nuevas de ayer
